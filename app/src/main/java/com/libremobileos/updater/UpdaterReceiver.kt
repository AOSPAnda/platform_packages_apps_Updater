...
class UpdaterReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_INSTALL_REBOOT = "com.libremobileos.updater.action.INSTALL_REBOOT"
        ...
        private fun showUpdateFailedNotification(context: Context) {
            ...
            val builder = NotificationCompat.Builder(context, INSTALL_ERROR_NOTIFICATION_CHANNEL)
